...
#CFLAGS = -march=westmere -O3 -Wall -Wextra -Wno-maybe-uninitialized -std=c99 -flto -DZENGINE_DISABLE_AUDIO -DZENGINE_MATRIXMODE_MANUAL -DZENGINE_SPRITE_MAPMODE_MANUAL
CFLAGS = -O1 -Wall -Wextra -Wno-maybe-uninitialized -std=c99 -DZENGINE_DISABLE_AUDIO -DZENGINE_MATRIXMODE_MANUAL -DZENGINE_SPRITE_MAPMODE_MANUAL
LDFLAGS = -lm -lpthread
